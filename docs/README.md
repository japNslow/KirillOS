...
| Команда | Синтаксис | Назначение |
| :--- | :--- | :--- |
| `kano` | `kano <файл>` | Текстовый экранный редактор для написания программ. |
| `kdhe` | `kdhe <файл>` | Интерактивный hex-редактор для низкоуровневого анализа и модификации байткода. |
| `kdhe disk` | `kdhe disk <LBA>` | Просмотр и редактирование сырых секторов жесткого диска ATA. |
